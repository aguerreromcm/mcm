...
class Menu
{
    ...
    private function opcionesPagos()
    {
        return [
            ...
            $this->enlace('Pagos App', '/Pagos/CorteEjecutivo/', ['ADMIN', 'CAJA', 'FLHR', 'HEDC', 'JULM', 'CRCV', 'LUMM', 'EMGL', 'PEAE', 'MCDP', 'LVGA', 'LGFR', 'JGGK', 'MBAE']),
    ...
    private function opcionesOperaciones()
    {
        return [
            ...
            $this->enlace('Reporte Acreditado', '/Operaciones/ReporteAcreditado', ['ADMIN', 'CPAGO', 'GOBA', 'LGFR', 'MCDP', 'MAPH', 'VMSM', 'BAMA'])
        ];
    }
    ...
    private function opcionesClientes()
    {
        return [
            ...
            $this->enlace('Registro Lista Negra', '/Clientes/RegistroListaNegra/', ['ADMIN', 'MAPH', 'LGFR', 'MCDP',]),
        ];
    }
